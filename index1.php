 	 ...
 	 <div class="row content">
   		 <div class="col-sm-3 sidenav">
     		 <div class="panel panel-primary">
     			<div class="panel-heading">Toy Add</div>
           	...
           	<form action="handling.php" method="post" enctype="MULTIPLE/form-data">
             	...
             	<div class="form-group">
               	...
               	<td><input type="text" name="nhan hieu" class="form-control"></td>
             	</div>
              <input type="submit" class="btn btn btn-success" name="Add" id="Add" value="Add">
            </form>
      		</div>
     		</div>
    	</div>
